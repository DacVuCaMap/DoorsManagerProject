...
export const createNewTotalGroupArray = (): TotalGroup[] =>{
    const cpvc : TotalItem = new TotalItem(1,0,1,"Chi phí vận chuyển",0,"CPVC",0,"bộ");
    const cpkd : TotalItem = new TotalItem(1,0,1,"Chi phí hồ sơ kiểm định PCCC",0,"BCA",0,"bộ",-1);
