...
export const createNewTotalGroupArray = (): TotalGroup[] =>{
    const cpvc : TotalItem = new TotalItem(0,1,1,1,"Chi phí vận chuyển",0,"",0,"bộ",0);
    const cpkd : TotalItem = new TotalItem(0,1,1,1,"Chi phí hồ sơ kiểm định PCCC",0,"BCA",0,"bộ",-1);
