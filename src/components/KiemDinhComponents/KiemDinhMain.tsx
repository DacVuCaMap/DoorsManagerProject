...
import KiemDinhDefaultValue from './KiemDinhDefaultValue';
type Props = {
    ...
    return (
        <div className='w-full flex flex-col px-2'>
            <div className='mb-4 ml-auto'>
                <KiemDinhDefaultValue />
            </div>
            <div className='border-b border-gray-500 text-gray-200 flex text-sm sticky top-0 z-10 bg-gray-900'>
                <div className='w-1/12 p-2 text-center font-bold'>STT</div>
                <div className='w-11/12 flex flex-row'>
                    <div className='w-3/12 p-2 text-center font-bold'>Mẫu cửa</div>
                    <div className='w-1/12 p-2 text-center font-bold'>Độ dày thép cánh</div>
                    <div className='w-1/12 p-2 text-center font-bold'>Phạm vị áp dụng</div>
