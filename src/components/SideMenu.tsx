                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link href="/baogia/add"
                                    ...
                                    <span className="ml-3">Báo giá</span>
                                </Link>
                            </li>
                            <li>
                                <Link href="/phukien/list?page=0&size=100&search"
                                    className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">Phụ kiện</span>
                            ...
                            <li>
                                <Link href="/ganlenh"
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">Lệnh tắt</span>
                                </Link>
                            </li>
                            <li>
                                <a href="#"
